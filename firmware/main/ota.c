...
static const int OTA_LOG_LEVEL = ESP_LOG_INFO; //ESP_LOG_WARN;
    ...
    if (message.info.status == ESP_ZB_ZCL_STATUS_SUCCESS) {
        ...
        case ESP_ZB_ZCL_OTA_UPGRADE_STATUS_START:
            ...
            if (NULL == s_ota_partition) {
                ...
                ESP_LOGI(TAG, "-- OTA already started");
            }
            break;
        ...
        case ESP_ZB_ZCL_OTA_UPGRADE_STATUS_ABORT:
            ...
            s_ota_partition = NULL;
            s_ota_handle = 0;
            ESP_LOGI(TAG, "-- OTA upgrade abort: %s", esp_err_to_name(ret));
            break;
        default:
