...
#define OTA_UPGRADE_RUNNING_FILE_VERSION    100                                     /* The attribute indicates the file version of the running firmware image on the device */
#define OTA_UPGRADE_DOWNLOADED_FILE_VERSION 100                                     /* The attribute indicates the file version of the downloaded firmware image on the device */
